module SlackNotification
  ...
  def sendNotification(data = {})
    ...
    if Rails.env.development?
      $notifier = Slack::Notifier.new "https://hooks.slack.com/services/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", channel: '#mayank-notifications-test', username: 'mayankbot'
